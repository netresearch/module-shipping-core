...
namespace Netresearch\ShippingCore\Test\Integration\Model\AdditionalFee;
...
class CreditmemoExportTest extends TestCase
{
    ...
    private static function assertTotalsNotLoaded(CreditmemoInterface $creditMemo)
    {
        ...
        self::assertEmpty($extensionAttributes->getNrshippingAdditionalFee());
        self::assertEmpty($extensionAttributes->getNrshippingAdditionalFeeInclTax());
        self::assertEmpty($extensionAttributes->getBaseNrshippingAdditionalFee());
        self::assertEmpty($extensionAttributes->getBaseNrshippingAdditionalFeeInclTax());
    }
    ...
    private static function assertTotalsLoaded(CreditmemoInterface $creditMemo)
    {
        ...
        self::assertEquals(
            ...
            $extensionAttributes->getNrshippingAdditionalFee()
        );

        self::assertEquals(
            self::$additionalFees[TotalsManager::ADDITIONAL_FEE_INCL_TAX_FIELD_NAME],
            $extensionAttributes->getNrshippingAdditionalFeeInclTax()
        );

        self::assertEquals(
            self::$additionalFees[TotalsManager::ADDITIONAL_FEE_BASE_FIELD_NAME],
            $extensionAttributes->getBaseNrshippingAdditionalFee()
        );

        self::assertEquals(
            self::$additionalFees[TotalsManager::ADDITIONAL_FEE_BASE_INCL_TAX_FIELD_NAME],
            $extensionAttributes->getBaseNrshippingAdditionalFeeInclTax()
        );
    }
