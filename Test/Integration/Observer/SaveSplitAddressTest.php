...
namespace Netresearch\ShippingCore\Test\Integration\Observer;
...
use Netresearch\ShippingCore\Observer\SplitAddress;
...
class SaveSplitAddressTest extends TestCase
{
    ...
    public function saveAddress(
        ...
        $this->assertEquals($expectedName, $attributes ? $attributes->getNrshippingStreetName() : '');
        $this->assertEquals($expectedNumber, $attributes ? $attributes->getNrshippingStreetNumber() : '');
        $this->assertEquals($expectedSupplement, $attributes ? $attributes->getNrshippingStreetSupplement() : '');
    }
}
